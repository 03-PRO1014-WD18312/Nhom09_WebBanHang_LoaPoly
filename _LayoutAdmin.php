    ...
    if(isset($_SESSION['Email'])){
        ...
        if ($result->num_rows > 0) 
        {
            while($row = $result->fetch_assoc()) {
                ...
                header('location:/MyWeb/WebPage/_LayoutWebPage.php');
                }else{
                    $_SESSION['ID'] = $row['UserID'];
                }
            }
                ...
                <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="/MyWeb/myAdmin/ProcessLogoutAD.php?id=0">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
                        ...
                        <div class="sb-sidenav-menu">
                            <div class="nav">
                                ...
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                        ...
                                        <a class="nav-link" href="/MyWeb/MyAdmin/_LayoutAdmin.php?/myLayout=ProductList">Product</a>
                                        <a class="nav-link" href="/MyWeb/myAdmin/_LayoutAdmin.php?myLayout=listCate">Category</a>
                                        <a class="nav-link" href="/MyWeb/myAdmin/_LayoutAdmin.php?myLayout=Order">Order</a>
                                        <a id="ProcessOrder" class="nav-link" href="/MyWeb/myAdmin/_LayoutAdmin.php?myLayout=ProcessOrder">Customer Order(<span style="color:red;font-weight:bold" id="quantityOR"><?php echo $dem ?></span>)</a>
                                      
                                        <a class="nav-link" href="/MyWeb/myAdmin/_LayoutAdmin.php?myLayout=myComment">Comment</a>
